...
Un template sert à accélérer la création d’un document, d’un cadrage, d’un suivi, d’une livraison ou d’un projet sans repartir de zéro.
...
| `template-fiche-contenu-public-candidat.md` | Template | Analyse rapide d’un contenu public candidat. |
...
| `template-script-video-demo-madsuite.md` | Template | Script vidéo Démo MADSuite conforme Machine à clients et Revenue Core. |
...
| `template-mini-sondage-feedback-early-access-madsuite.md` | Template | Mini-sondage feedback Early Access MADSuite. |
| `template-analyse-feedback-early-access-madsuite.md` | Template | Analyse feedback Early Access MADSuite. |
...
SYSTEME_MAD/07-TEMPLATES/template-script-video-demo-madsuite.md
