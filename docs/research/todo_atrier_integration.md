...
La passe actuelle a produit six résumés :

- `docs/research/resume_atrier_madsuite_spec_v2.md`
- `docs/research/resume_atrier_web_mobile_accessibilite.md`
- `docs/research/resume_atrier_securite_vie_privee_juridique_fiscal.md`
- `docs/research/resume_atrier_geospatial_gps_offline.md`
- `docs/research/resume_atrier_time_monitoring_ethique.md`
- `docs/research/todo_atrier_integration.md`
...
- [ ] Relier `resume_atrier_madsuite_spec_v2.md` à la charte éthique fondatrice.
...
- [ ] Créer `docs/research/modules-metiers/geospatial/`.
...
1. Créer ADR time tracking vs monitoring.
2. Créer checklist Loi 25 / privacy MADSuite.
3. Créer standard Web mobile/accessibilité.
4. Créer checklist PWA release.
5. Créer registre R&D RS&DE.
6. Nettoyer et déplacer les fichiers `atrier` vers dossiers définitifs.
...
La prochaine étape est de transformer ces résumés en standards, checklists et ADR officiels.