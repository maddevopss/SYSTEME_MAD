...
| DP-002 | MADSuite doit prioriser le Revenue Core avant les modules R&D avancés. | Acceptée | Business | Générer de la valeur rapidement pour travailleurs autonomes et PME. | `madsuite-madproof-roadmap.md`, `spec-revenue-core-madsuite.md` |
| DP-003 | Le MVP doit rester centré sur clients, projets, temps, factures, estimés, paiements et revenus. | Acceptée | Produit | Assurer une base vendable et compréhensible. | `index-global-madsuite.md`, `spec-revenue-core-madsuite.md` |
...
| DP-011 | Start Now, Sort Later est une direction UX prioritaire pour réduire la friction de démarrage. | À valider | UX | Permettre de commencer sans forcer immédiatement le classement client/projet. | `glossaire`, `roadmap`, `spec-revenue-core-madsuite.md` |
| DP-012 | Le temps non classé doit être présenté comme un état neutre, jamais comme un oubli fautif. | Acceptée | UX | Éviter la culpabilisation et respecter l’accessibilité cognitive. | `glossaire`, `spec-revenue-core-madsuite.md` |
...
| DP-017 | Le produit doit éviter le jargon technique dans les surfaces client. | Acceptée | Communication | MADSuite doit être compréhensible par travailleurs autonomes et PME. | `ai-context.md`, `spec-machine-a-clients-madsuite.md` |
...
| DP-021 | Le Revenue Core doit optimiser le chemin vers la première facture. | Acceptée | Revenue Core | La première valeur concrète de MADSuite est la capacité de créer, envoyer ou suivre une facture rapidement. | `spec-revenue-core-madsuite.md` |
| DP-022 | Stripe ne doit pas être obligatoire avant la première facture. | Acceptée | Revenue Core | L’utilisateur doit pouvoir créer une facture même si le paiement en ligne n’est pas encore configuré. | `spec-revenue-core-madsuite.md` |
| DP-023 | La Machine à clients doit vendre un résultat simple, pas une architecture ni une théorie cognitive. | Acceptée | Acquisition | Le visiteur doit comprendre clients, temps, factures et revenus avant les concepts avancés. | `spec-machine-a-clients-madsuite.md` |
| DP-024 | L’activation produit doit viser la première facture plutôt qu’une configuration parfaite. | Acceptée | Onboarding | L’utilisateur doit atteindre une valeur concrète rapidement. | `spec-machine-a-clients-madsuite.md`, `spec-revenue-core-madsuite.md` |
...
| DR-005 | Forcer une configuration complète avant la première facture. | Augmente la friction d’activation et retarde la valeur produit. | Refusée |
| DR-006 | Vendre MADSuite principalement comme outil IA. | Risque de brouiller la promesse business principale. | Refusée |
...
| DV-006 | Machine à clients | Quel message public convertit le mieux sans dérive médicale? | Test landing page. |
| DV-007 | Pricing | Quel prix permet d’atteindre rapidement le MRR visé sans freiner l’activation? | Test offre / early adopters. |
