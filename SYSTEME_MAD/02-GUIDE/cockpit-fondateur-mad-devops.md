...
Le cockpit n’ajoute pas une nouvelle couche de gestion.

Il oriente vers le bon document au bon moment.
...
| Préparer une proposition | `template-proposition-client-mad-devops.md` | Proposition claire et professionnelle. |
| Projet accepté | `starter-kit-projet-mad-devops.md` | Base de projet MAD DevOps. |
...
- proposer trop vite;
- donner un prix sérieux sur un besoin flou;
- transformer une idée vague en promesse ferme;
- oublier le hors périmètre.

## Ensuite

Si le besoin devient clair :
