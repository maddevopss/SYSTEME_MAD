...
> Généré automatiquement le 2026-08-02T11:32:24.825Z. Ne pas modifier manuellement ce fichier.
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `bleeband/SYSTEME_MAD` | Oui | 🟡 in_progress | [Governance dashboard](https://github.com/bleeband/SYSTEME_MAD/actions/runs/30745941724) | 0 | 0 | 6 | 0 | non vérifiable |
| `maddevopss/madsuite` | Oui | 🔴 failure | [Responsive Nightly Extended](https://github.com/maddevopss/madsuite/actions/runs/30741128020) | 0 | 0 | 0 | 0 | non vérifiable |
| `maddevopss/madsuite-frontend` | Oui | 🟢 success | [Frontend Main CI](https://github.com/maddevopss/madsuite-frontend/actions/runs/30697958310) | 2 | 0 | 0 | 1 | non vérifiable |
| `maddevopss/madsuite-backend` | Oui | 🟢 success | [Backend Main CI](https://github.com/maddevopss/madsuite-backend/actions/runs/30730918834) | 4 | 0 | 0 | 0 | non vérifiable |
| `maddevopss/desktop-agent` | Oui | 🟢 success | [Desktop Agent Guards](https://github.com/maddevopss/desktop-agent/actions/runs/30726353993) | 1 | 0 | 0 | 0 | non vérifiable |
