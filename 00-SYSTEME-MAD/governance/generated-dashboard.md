...
> Généré automatiquement le 2026-07-20T12:25:33.386Z. Ne pas modifier manuellement ce fichier.
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `bleeband/SYSTEME_MAD` | Oui | 🟡 in_progress | [Governance dashboard](https://github.com/bleeband/SYSTEME_MAD/actions/runs/29742144850) | 0 | 6 | 7 | 7 | non vérifiable |
| `maddevopss/madsuite` | Oui | 🔴 failure | [Responsive Nightly Extended](https://github.com/maddevopss/madsuite/actions/runs/29734034851) | 0 | 0 | 0 | 0 | non vérifiable |
| `maddevopss/madsuite-frontend` | Oui | 🟢 success | [Frontend PR CI](https://github.com/maddevopss/madsuite-frontend/actions/runs/29701158954) | 6 | 0 | 0 | 1 | non vérifiable |
| `maddevopss/madsuite-backend` | Oui | 🟢 success | [Backend PR Guards](https://github.com/maddevopss/madsuite-backend/actions/runs/29741299983) | 5 | 0 | 0 | 0 | non vérifiable |
...
| `maddevopss/e2e` | Oui | 🔴 failure | [Full-stack authenticated E2E](https://github.com/maddevopss/e2e/actions/runs/29696377779) | 3 | 0 | 0 | 0 | non vérifiable |
