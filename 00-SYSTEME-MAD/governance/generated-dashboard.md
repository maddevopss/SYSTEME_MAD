...
> Généré automatiquement le 2026-07-26T16:09:14.339Z. Ne pas modifier manuellement ce fichier.
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `bleeband/SYSTEME_MAD` | Oui | 🟡 in_progress | [Registry integrity](https://github.com/bleeband/SYSTEME_MAD/actions/runs/30209755225) | 2 | 0 | 6 | 0 | non vérifiable |
...
| `maddevopss/desktop-agent` | Oui | 🟢 success | [Desktop Agent Guards](https://github.com/maddevopss/desktop-agent/actions/runs/30182237296) | 1 | 0 | 0 | 0 | non vérifiable |
| `maddevopss/e2e` | Oui | 🟢 success | [E2E CI](https://github.com/maddevopss/e2e/actions/runs/30138150259) | 0 | 0 | 0 | 0 | non vérifiable |
