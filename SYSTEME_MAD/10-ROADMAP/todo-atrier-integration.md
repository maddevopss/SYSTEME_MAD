...
1. Consolider les trois fiches Web dans une annexe `compatibilite-web-apis-fallbacks.md` si nécessaire.
2. Ajouter au standard Web/PWA les ajouts durables : feature detection, fallback, API sensible = consentement.
